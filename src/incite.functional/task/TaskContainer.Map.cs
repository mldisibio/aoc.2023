...
public static partial class TaskContainer
{
    ...
    /// <summary>
    /// Apply <paramref name="Completed"/> to the <typeparamref name="TResult"/> result from <paramref name="task"/> 
    ...
    /// <summary>Apply <paramref name="map"/> to the <typeparamref name="TResult"/> result from <paramref name="task"/> and return a <see cref="Task{TResult}"/></summary>
