...
[Serializable]
public class AssignedErrorException : Exception, ISerializable
{
    ...
    ///<inheritdoc/>
    public AssignedErrorException(SerializationInfo info, StreamingContext context) : base(info, context) { }
